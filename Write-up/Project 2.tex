...
\begin{table}[H]
\begin{tabular}{c c}
\begin{subfigure}{0.4\textwidth}\centering\includegraphics[scale = .25]{../Images/358.png}\caption{Case 358: Classified as 4, truth is 7.}\label{fig:taba}\end{subfigure}&
\begin{subfigure}{0.4\textwidth}\centering\includegraphics[scale = .25]{../Images/445.png}\caption{Case 445: Classified as 0, truth is 6.}\label{fig:taba}\end{subfigure}\\
\newline
\begin{subfigure}{0.4\textwidth}\centering\includegraphics[scale = .25]{../Images/551.png}\caption{Case 551: Classified as 1, truth is 7.}\label{fig:taba}\end{subfigure}&
\begin{subfigure}{0.4\textwidth}\centering\includegraphics[scale = .25]{../Images/583.png}\caption{Case 583: Classified as 7, truth is 2.}\label{fig:taba}\end{subfigure}\\
\newline
\begin{subfigure}{0.4\textwidth}\centering\includegraphics[scale = .25]{../Images/646.png}\caption{Case 646: Classified as 6, truth is 2.}\label{fig:taba}\end{subfigure}&
\begin{subfigure}{0.4\textwidth}\centering\includegraphics[scale = .25]{../Images/740.png}\caption{Case 740: Classified as 9, truth is 4.}\label{fig:taba}\end{subfigure}\\
\newline
\begin{subfigure}{0.4\textwidth}\centering\includegraphics[scale = .25]{../Images/947.png}\caption{Case 947: Classified as 9, truth is 8.}\label{fig:taba}\end{subfigure}&
\begin{subfigure}{0.4\textwidth}\centering\includegraphics[scale = .25]{../Images/965.png}\caption{Case 965: Classified as 0, truth is 6.}\label{fig:taba}\end{subfigure}
\end{tabular}
\end{table}
...
>>>>>>> 38d9c45aab0400b6ca560cf9f094467e2a03122b
\end{document}
